...
#-------------------------------------------------------
        ...
        self.noisy=nn.Sequential(Rain_streak(3,32,3))
    ...
    def forward(self, input):
        ...
        Z_difference= input
        X = Variable(torch.zeros(batch_size, 3, row, col))
        Y = Variable(torch.zeros(batch_size, 3, row, col))
        ...
        for i in range(self.iteration):
            ...
            Y_difference=self.noisy(O_difference)
            
            X_difference=self.image(O_difference)
